...
error_reporting(0);
    ...
    while($row = $result->fetch_assoc()) {
        if ($row['id'] == $_GET['id']){
                    ...
                    echo '<form  class="form-inline m-2" action="updateDoctors.php" method="POST" autocomplete="off" enctype="multipart/form-data">';
                    ...
                    echo '<div class="form-group">';
                    echo '<label for="image">Upload Image</label><br>';
